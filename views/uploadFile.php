...
<div class="container" ng-controller="uploadFileCtrl">
    <form method="post" action="" enctype="multipart/form-data">
        ...
        <br>
        <div class="row">
            <div class="col-md-2">Lecturer: </div> 
            <div class="col-md-5"><input type="text" class="form-control input-lg" name="lecturer" placeholder="Alan Turing" autocomplete="on" required></div>
        ...
        <br>
        <div class="row">
            <div class="col-md-2">Notes<br> (min=1;max=255 chars)</div>
            <div class="col-md-5">
        ...
        <div class="row">
            <div class="col-md-2">
                ...
                Author: </div> <div class="col-md-4"><input type="text" class="form-control input-lg" name="author" placeholder="Steve Paul Jobs" autocomplete="on" <?php
        ...
        <div class="row"> 
            ...
            <div class="col-md-4">
                ...
                <input type="reset" class="btn btn-primary btn-success btn-lg" value="Reset">
            </div>
        </div>
    </form>
